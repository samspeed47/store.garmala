...
export default function WoodCategoryPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0c] text-foreground pt-28 pb-16 selection:bg-gold selection:text-black">
          ...
          <div className="w-full md:w-[60%] relative z-10">
            <div className="relative aspect-[16/10] w-full bg-[#0a0a0c] overflow-hidden select-none">
              <motion.img 
                ...
                alt="Woodworks Architectural Timber Joinery"
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
          ...
          >
            ...
            <p className="text-white/70 text-base md:text-lg font-sans font-light leading-relaxed max-w-2xl mb-8">
              Garmala is developing a considered collection of architectural woodwork, joinery and timber finishes for residential spaces. The focus is on material quality, craftsmanship, functionality and timeless design.
            </p>
      ...
      {/* Part 2D — Bespoke Woodwork / Project Sourcing CTA */}
      <section className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        >
          ...
          <p className="text-white/70 text-base md:text-lg font-sans font-light leading-relaxed max-w-xl mb-8">
            For residential projects requiring custom cabinetry, doors, wardrobes, timber detailing or built-in joinery, Garmala can assist with sourcing and execution through its project network.
          </p>
          <Link 
            href="/about"
